...
public interface UserMapper {
    ...
    @Named("AdminResTo")
    UserAdminDtoResponse usersAdminToUsersAdminResponse(Users users);
    @IterableMapping(qualifiedByName = "AdminResTo")
    List<UserAdminDtoResponse> usersAdminListToUsersAdminResponseList(List<Users> users);
